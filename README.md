# ForgeDev Dashboard (Vue)

> Admin dashboard + analytics UI — Vue/Nuxt frontend
...
Part of the **Dashboard** domain. This frontend connects to:

| Repo | Role |
|------|------|
| forgedev-dashboard-backend | Backend API |
